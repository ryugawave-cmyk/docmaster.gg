 ...
 * lossily. (The pure-reflow export is an opt-in — see verify-positioned-docx.mjs.)
 * This drives the REAL browser modules (blockModelToDocx + docxToBlockModel) in Edge,
 * since both need DOMParser / canvas / DecompressionStream that Node lacks.
 *
